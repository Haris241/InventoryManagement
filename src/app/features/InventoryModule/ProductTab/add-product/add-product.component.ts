...
export class AddProductComponent implements OnInit {
  ...
  productModel = signal<ProductDTO>(this.productService.defaultProduct);
  ...
  updateVariantAttributeField<K extends keyof ProductAttributeValueDto>(
    ...
    this.productModel.update(prev =>
      this.productService.updateVariantAttributeField(prev, variantIndex, attrIndex, field, value)
    );
      ...
      .subscribe({
        next: () => {
          ...
          this.productForm().reset({
            ...this.productService.defaultProduct,
            variants: [{ ...this.productService.defaultVariant }]
          });
          this.submit.set(false);
